...
st.set_page_config(page_title="Ordenador de Programa AC/WO", page_icon="✈️", layout="centered")

st.title("✈️ Ordenador de Programa AC/WO")
st.caption("Agrupa por matrícula y WO, ordena WEEKLY, DAILY, EO normales y defectos, y genera un Excel profesional.")
    ...
    if st.button("Generar Excel ordenado", type="primary"):
        try:
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                process_file(input_path, output_path, filename=uploaded_file.name)
