...
def _norm_col(col: str) -> str:
    """Normaliza nombres de columnas para tolerar mayúsculas, espacios y acentos."""
...
def _clean(value) -> str:
    """Convierte NaN/None/espacios raros a texto limpio, conservando saltos de línea."""
    if pd.isna(value):
        return ""
...
def _build_task(row: pd.Series) -> str:
    """Usa EO; si viene vacío, intenta usar campos de task card/defecto."""
...
def _build_description(row: pd.Series) -> str:
    """
    Descripción = EO_DESCRIPTION completo.
    Si PN y SN existen, agrega: P/N xxx S/N yyy.
    Si EO_DESCRIPTION viene vacío, usa descripción/notas de defectos como respaldo.
    """
